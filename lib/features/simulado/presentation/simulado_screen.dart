...
class _SimuladoScreenState extends ConsumerState<SimuladoScreen>
  ...
  void _finish() {
    ...
    final result = QuizResult(
      ...
      correct: correct,
      xpEarned: correct * 5,
      timeTaken: Duration(seconds: _clock.elapsedSecondsAt(DateTime.now())),
      answers: answers,
    );
              ...
              Semantics(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: isTimeLow ? AppColors.accent : AppColors.border),
                  ),
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    Icon(Icons.timer_rounded,
                        color:
                            isTimeLow ? AppColors.accent : AppColors.textMuted,
                        size: 12),
                ...
                children: [
                  ...
                  ...q.options.asMap().entries.map((e) {
                    ...
                    return GestureDetector(
                      onTap: () =>
                          setState(() => _answers[_currentIndex] = opt.id),
                      child: AnimatedContainer(
