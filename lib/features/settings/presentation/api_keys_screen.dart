    ...
    try {
      ...
      if (!config.hasSelectedProviderKey) {
        return const SyncFeedbackResult(
          ...
          message:
              'Configuração salva. O aplicativo usará a IA padrão do servidor Quiz Vance.',
        );
      }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              // Banner: IA padrão já está ativa
              Container(
                  ...
                  children: [
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'IA do Quiz Vance já está ativa',
                            style: TextStyle(
                              color: AppColors.success,
                              fontSize: 13,
                          ...
                          SizedBox(height: 2),
                          Text(
                            'Você já pode gerar quizzes sem precisar de uma chave pessoal. As chaves abaixo são opcionais e permitem usar sua própria cota.',
                            style: TextStyle(
