...
typedef RemoteErrorReporter = Future<void> Function(
  String name,
  Object error,
...
class AppObservability {
  ...
  RemoteErrorReporter? _remoteReporter;

  void registerRemoteReporter(RemoteErrorReporter reporter) {
  ...
  void reportError(
    ...
    if (_remoteReporter != null) {
      try {
        _remoteReporter!(name, error, stackTrace, attributes);
      } catch (_) {}
    }
  }
